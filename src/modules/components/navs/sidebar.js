...
const SideBar = ({ fromHeader = false, hide }) => {
  ...
  return (
    <>
      <div className="h-full shadow" style={{ height: "100vh" }}>
        <div className="h-8"></div>
        <div>
          <Logo className="w-32 h-16 ml-8 mb-4" />
          <p className="mt-2 text-mountainmist-500 ml-8">Admin Menu</p>
          <aside className="ml-8 mt-8">
            <ul>
              <li className="mb-6">
                <NavLink
                  className="text-mountainmist-500 flex items-center "
                ...
                >
                  ...
                  >
                    ...
                    <svg
                      width="23"
                      height="21"
                      className=" fill-current mx-auto mt-2"
              ...
              <li className="mb-6">
                ...
                >
                  ...
                  <p className="ml-4">Bot Template</p>
                </NavLink>
              </li>
              <li className="mb-6">
                <NavLink
              ...
              <li className="mb-6">
                ...
                >
                  ...
                  <p className="ml-4">Tooltip Management</p>
                </NavLink>
              </li>
              <li className="mb-6">
                <NavLink
                ...
                >
                  ...
                  <p className="ml-4">Emailing System</p>
                </NavLink>
              </li>
              <li className="mb-6">
                <NavLink
                ...
                >
                  ...
                  >
                    ...
                    >
                      <path
                        d="M17.656 10.586a1.172 1.172 0 1 0 2.344 0v-5.86h-2.344v5.86ZM17.656 12.93H8.242a2.346 2.346 0 0 1-2.344-2.344v-5.86H0v11.758h17.656V12.93ZM6.453 17.656l-.39 1.172H4.726V20h8.203v-1.172h-1.336l-.39-1.172H6.452ZM10 2.969h3.516V4.14H10V2.969Z"
                      />
                      <path
                        d="M7.07 0v10.586c0 .647.525 1.172 1.172 1.172h8.568a2.317 2.317 0 0 1-.326-1.172V0H7.07Zm7.617 10H8.829V8.828h5.86V10Zm0-2.344H8.829V6.484h5.86v1.172Zm0-2.343H8.829V1.796h5.86v3.516Z"
                      />
                    </svg>
                  </div>
                  <p className="ml-4">PKGs Subscriptions</p>
                </NavLink>
              </li>
              <li className="mb-6">
                <NavLink
              ...
              <li className="mb-6">
                <Link
                  className="text-mountainmist-500 font-semibold flex items-center "
                  to="/"
                >
